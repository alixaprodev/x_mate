...
![Timeline ad blocked](store-screenshots/1-timeline-before-after.png)
![Sidebar ad blocked](store-screenshots/2-sidebar-before-after.png)
...
icons/           Extension icons (generated by scripts/gen_icons.py)
scripts/         Dev-only helper scripts, not part of the packaged extension
```
